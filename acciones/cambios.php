...
<body>
    ...
    <div class="principal">
        ...
        <div class="formulario text-center d-flex justify-content-center align-items-center flex-column">
            <h1 style="color: white;"><b>Cambios de datos</b></h1>
            <br>
            <form style="background: white" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" class="text-center" method="POST">
              <br>
